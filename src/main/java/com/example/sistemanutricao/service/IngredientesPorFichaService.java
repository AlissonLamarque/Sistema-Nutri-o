...
public class IngredientesPorFichaService {
    ...
    public List<IngredientePorFichaGetDTO> createIngredientesPorFicha(
    ...
    public IngredientePorFichaGetDTO updateIngredientePorFicha(IngredientePorFichaDTO dto, Long id) {
