...
public class PreparacaoService {
    ...
    public PreparacaoGetDTO createPreparacao(PreparacaoCreateDTO dto) {
    ...
    public Preparacao updatePreparacao(PreparacaoUpdateDTO dto) {
