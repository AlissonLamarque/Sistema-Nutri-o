...
public class PerfilNutricionalService {
    ...
    public PerfilNutricionalGetDTO createPerfilNutricional(PerfilNutricionalCreateDTO dto) {
    ...
    public PerfilNutricional updatePerfilNutricional(Long id, PerfilNutricionalUpdateDTO dto) {
        PerfilNutricional perfil = perfilRepository.findById(id)
