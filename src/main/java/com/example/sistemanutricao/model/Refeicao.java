...
public class Refeicao {
    ...
    public Refeicao(Long id, String nome, String kcalTotal, Status status, List<FichasPorRefeicao> fichasPorRefeicao) {
        this.id = id;
        this.nome = nome;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, refeicao.id) && Objects.equals(nome, refeicao.nome) && Objects.equals(kcalTotal, refeicao.kcalTotal) && status == refeicao.status && Objects.equals(fichasPorRefeicao, refeicao.fichasPorRefeicao);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, nome, kcalTotal, status, fichasPorRefeicao);
    }
    ...
    public String toString() {
        return "Refeicao{" +
                ...
                ", kcalTotal='" + kcalTotal + '\'' +
                ", status=" + status +
                ", fichasPorRefeicao=" + fichasPorRefeicao +
                '}';
    }
}
